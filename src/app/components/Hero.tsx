...
export default function Hero() {
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-[rgba(255,232,188,0.68)] pt-24">
      {/* Content */}
      <div className="max-w-2xl text-center px-4 z-10 relative">
        ...
        <div className="space-y-4 mb-8">
          <p className="text-2xl text-[#5a3e36] italic">
        ...
        <div>
          <Link
            href="/diary"
            className="relative inline-block group bg-gradient-to-br from-[#ffd49e] to-[#f8b878] text-[#683b3b] font-medium px-8 py-3 rounded-lg text-lg shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-[#e8c9a7] hover:border-[#683b3b] hover:translate-y-[-2px]"
